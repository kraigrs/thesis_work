...
#
# perl classify.0.5_SDBM.pl ../McManus/constitutive_regions_overlap_filtered.bed zhr z30 ../mel_mel_data/mRNA-Seq/zhrXz30/zhrXz30.mate1.zhr.mosaik.bed.lifted.converted ../mel_mel_data/mRNA-Seq/zhrXz30/zhrXz30.mate2.zhr.mosaik.bed.lifted.converted ../mel_mel_data/mRNA-Seq/zhrXz30/zhrXz30.mate1.z30.mosaik.bed.lifted.converted ../mel_mel_data/mRNA-Seq/zhrXz30/zhrXz30.mate2.z30.mosaik.bed.lifted.converted ../mel_mel_data/mRNA-Seq/zhrXz30 zhrXz30_v2 &
#
# perl classify.0.5_SDBM.pl ../McManus/constitutive_regions_overlap_filtered.bed zhr z30 ../mel_mel_data/mRNA-Seq/zhrXz30/zhrXz30.mate1.zhr.mosaik.bed.lifted.converted ../mel_mel_data/mRNA-Seq/zhrXz30/zhrXz30.mate2.zhr.mosaik.bed.lifted.converted ../mel_mel_data/mRNA-Seq/zhrXz30/zhrXz30.mate1.z30.mosaik.bed.lifted.converted ../mel_mel_data/mRNA-Seq/zhrXz30/zhrXz30.mate2.z30.mosaik.bed.lifted.converted ../mel_mel_data/mRNA-Seq/zhrXz30 zhrXz30_v2 &
#
###################################################################################
...
tie(%readNames, "SDBM_File", "$out_dir/names", O_CREAT|O_RDWR, 0666) or die "Cannot open file $out_dir/names: $!\n";

# initialize the database to store all read information (mate and species indicator)
#unlink "database" ;
system "touch $out_dir/database";
tie(%readList, "SDBM_File", "$out_dir/database", O_CREAT|O_RDWR, 0666) or die "Cannot open file $out_dir/database: $!\n";

# initialize the database to store file-specific reads to remove unique duplicates
#unlink "DB11" ;
system "touch $out_dir/DB11";
tie(%readList11, "SDBM_File", "$out_dir/DB11", O_CREAT|O_RDWR, 0666) or die "Cannot open file $out_dir/DB11: $!\n";
...
tie(%readList21, "SDBM_File", "$out_dir/DB21",O_CREAT|O_RDWR, 0666) or die "Cannot open file $out_dir/DB21: $!\n";
...
tie(%readList12, "SDBM_File", "$out_dir/DB12", O_CREAT|O_RDWR, 0666) or die "Cannot open file $out_dir/DB12: $!\n";
...
tie(%readList22, "SDBM_File", "$out_dir/DB22",O_CREAT|O_RDWR, 0666) or die "Cannot open file $out_dir/DB22: $!\n";
