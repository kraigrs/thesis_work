    ...
    if($s1gDNA{$locus} && $s2gDNA{$locus})
    {
         ...
         $par{$locus}[1] > $LBparHyb1s2 && $par{$locus}[1] < $UBparHyb1s2)
      {
        printf PARHYB1 ("\n$locus\t%.0f\t%.0f\t%.0f\t%.0f\t%.0f\t%.0f",
                        $par{$locus}[0]*$correctS1,
                        $par{$locus}[1]*$correctS2,
                        $par{$locus}[2]*$correctS1+$par{$locus}[2]*$correctS2,
      ...
      {
        printf PARHYB2 ("\n$locus\t%.0f\t%.0f\t%.0f\t%.0f\t%.0f\t%.0f",
                        $par{$locus}[0]*$factorS1*$correctS1,
                        $par{$locus}[1]*$factorS2*$correctS2,
                        $par{$locus}[2]*$factorS1*$correctS1+$par{$locus}[2]*$factorS2*$correctS2,
