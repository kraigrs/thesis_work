...
#
# E.g. perl processData.pl <species1> <species2> <speciesfile> <hyb1file> <hyb2file> <out_dir>
#
  ...
  foreach $locus (keys %loci)   
  {
       ...
       $par{$locus}[1] > $LBparHyb1s2 && $par{$locus}[1] < $UBparHyb1s2)
    {
      printf PARHYB1 ("\n$locus\t%.0f\t%.0f\t%.0f\t%.0f\t%.0f\t%.0f",
                      $par{$locus}[0]*$factorParHyb1s1,$par{$locus}[1]*$factorParHyb1s2,
                      $par{$locus}[2]*$factorParHyb1s1+$par{$locus}[2]*$factorParHyb1s2,
    ...
    {
      printf PARHYB2 ("\n$locus\t%.0f\t%.0f\t%.0f\t%.0f\t%.0f\t%.0f",
                      $par{$locus}[0]*$factorParHyb2s1,$par{$locus}[1]*$factorParHyb2s2,
                      $par{$locus}[2]*$factorParHyb2s1+$par{$locus}[2]*$factorParHyb2s2,
