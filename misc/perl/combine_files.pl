...
#      <output> ==> should be clear (e.g. zhr+z30_zhrXz30.mosaik.exons.txt)
#
###################################################################################
...
sub main
{
  ...
  foreach $locus (keys %loci)   
  {
    ...
    {
      print OUT "\n$locus\t$par1{$locus}[0]\t$par1{$locus}[1]\t$par1{$locus}[2]\t$par2{$locus}[0]\t$par2{$locus}[1]\t$par2{$locus}[2]";
    }
  }
  close OUT;
}
