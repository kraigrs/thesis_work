...
perl ../perl/Give_Information.pl $1.tmp >$1.tmp1
paste $1.final1 $1.tmp1 >$1.final2
rm -f $1.tmp $1.tmp1

comm $4 $1.wholelist.txt | cut -f3 >$1.tmp
perl ../perl/Give_Information.pl $1.tmp >$1.tmp1
paste $1.final2 $1.tmp1 >$1.final3
rm -f $1.tmp $1.tmp1

comm $5 $1.wholelist.txt | cut -f3 >$1.tmp
perl ../perl/Give_Information.pl $1.tmp >$1.tmp1
paste $1.final3 $1.tmp1 >$FINAL
rm -f $1.tmp $1.tmp1

rm $1.final1 $1.final2 $1.final3