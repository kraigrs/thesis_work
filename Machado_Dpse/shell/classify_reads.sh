...
#var1=../../../McManus/constitutive_regions_overlap_filtered.bed var2=tsim var3=sec var4=../../sim_sec_data/simXsec_M_r3.final_info_rmDup.txt var5=../../sim_sec_data/simXsec_M_r3 qsub classify.sh
