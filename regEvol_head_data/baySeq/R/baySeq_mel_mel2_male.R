...
####################################################################################################
####################################################################################################
#data analyses for mel-mel parent vs hybrid 2 male
####################################################################################################
####################################################################################################
...
save(CD.post, file = "mel_mel_P_H2_M_posteriors.bayseq")
save(CD.prior, file = "mel_mel_P_H2_M_priors.bayseq")

write.table(cbind(CD.post@annotation,CD.post@posteriors), file = "mel_mel_P_H2_M_posteriors.txt",quote=FALSE,row.names=FALSE,col.names=FALSE,sep="\t")
