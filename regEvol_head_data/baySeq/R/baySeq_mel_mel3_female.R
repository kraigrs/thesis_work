...
####################################################################################################
####################################################################################################
#data analyses for mel-mel hybrid 1 vs 2 female
####################################################################################################
####################################################################################################
...
data1<-read.delim("zhrXz30_F_r1.genes.txt",header = T)
data2<-read.delim("zhrXz30_F_r2.genes.txt",header = T)
data3<-read.delim("zhrXz30_F_r3.genes.txt",header = T)
...
save(CD.post, file = "mel_mel_H1_H2_F_posteriors.bayseq")
save(CD.prior, file = "mel_mel_H1_H2_F_priors.bayseq")

write.table(cbind(CD.post@annotation,CD.post@posteriors), file = "mel_mel_H1_H2_F_posteriors.txt",quote=FALSE,row.names=FALSE,col.names=FALSE,sep="\t")
