...
if($mate =~ /^(\S+)\.(fastq|fq)$/)
{
  ...
  system "bowtie -q -p 1 -v 0 -m 1 --sam $pathebwt3 $matlab\.$label2\.bowtie_v0_m1\.un --un $matlab\.$label3\.bowtie_v0_m1\.un > $matlab\.$label3\.bowtie_v0_m1\.sam";

  system "perl ../perl/get_trim_reads.pl $matlab\.$label1\.bowtie_v0_m1\.un $matlab\.$label3\.bowtie_v0_m1\.un $mate $matlab\.un";
  ...
  system "bowtie -q -p 1 -v 0 -m 1 --trim3 13 --sam $pathebwt3 $matlab\.$label2\.bowtie_v0_m1_trim3_13\.un --un $matlab\.$label3\.bowtie_v0_m1_trim3_13\.un > $matlab\.$label3\.bowtie_v0_m1_trim3_13\.sam";

  system "perl ../perl/get_trim_reads.pl $matlab\.$label1\.bowtie_v0_m1_trim3_13\.un $matlab\.$label3\.bowtie_v0_m1_trim3_13\.un $matlab\.un $matlab\_trim3_13\.un";
  ...
  system "bowtie -q -p 1 -v 0 -m 1 --trim3 26 --sam $pathebwt3 $matlab\.$label2\.bowtie_v0_m1_trim3_26\.un --un $matlab\.$label3\.bowtie_v0_m1_trim3_26\.un > $matlab\.$label3\.bowtie_v0_m1_trim3_26\.sam";

  system "perl ../perl/get_trim_reads.pl $matlab\.$label1\.bowtie_v0_m1_trim3_26\.un $matlab\.$label3\.bowtie_v0_m1_trim3_26\.un $matlab\_trim3_13\.un $matlab\_trim3_26\.un";
  ...
  system "bowtie -q -p 1 -v 0 -m 1 --trim3 39 --sam $pathebwt3 $matlab\.$label2\.bowtie_v0_m1_trim3_39\.un --un $matlab\.$label3\.bowtie_v0_m1_trim3_39\.un > $matlab\.$label3\.bowtie_v0_m1_trim3_39\.sam";

  system "perl ../perl/get_trim_reads.pl $matlab\.$label1\.bowtie_v0_m1_trim3_39\.un $matlab\.$label3\.bowtie_v0_m1_trim3_39\.un $matlab\_trim3_26\.un $matlab\_trim3_39\.un";
  ...
  system "bowtie -q -p 1 -v 0 -m 1 --trim3 52 --sam $pathebwt3 $matlab\.$label2\.bowtie_v0_m1_trim3_52\.un --un $matlab\.$label3\.bowtie_v0_m1_trim3_52\.un > $matlab\.$label3\.bowtie_v0_m1_trim3_52\.sam";

  system "perl ../perl/get_trim_reads.pl $matlab\.$label1\.bowtie_v0_m1_trim3_52\.un $matlab\.$label3\.bowtie_v0_m1_trim3_52\.un $matlab\_trim3_39\.un $matlab\_trim3_52\.un";
  ...
  system "bowtie -q -p 1 -v 0 -m 1 --trim3 65 --sam $pathebwt3 $matlab\.$label2\.bowtie_v0_m1_trim3_65\.un --un $matlab\.$label3\.bowtie_v0_m1_trim3_65\.un > $matlab\.$label3\.bowtie_v0_m1_trim3_65\.sam";
}
