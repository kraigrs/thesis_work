...
# 
# Input: BED file of exons (or other regions), reference genome (FASTA)        
#
# Output: for each entry in BED file, the actual sequence from the genome
#
...
#
# perl get_sequences.pl <regions> <genome> <output>
#
######################################################################################
