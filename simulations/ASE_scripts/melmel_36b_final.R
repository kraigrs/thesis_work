...
nrow(subset(relevant,relevant > 1))/nrow(relevant);
...
pdf(file="/Users/kraigrs/Wittkopp/LabResearch/Simulating_ASE/revisions/new_plots/sim_36b_v1_box.pdf");
boxplot(ref_allele/(ref_allele+alt_allele) ~ relevant,data = data1, varwidth = TRUE,xlab="",ylab="",main="",xlim=c(1,9),ylim=c(0,1),pars = list(outpch=19,cex=0.2));
abline(h=0.5,lty=2,col="red");
dev.off();

pdf(file="/Users/kraigrs/Wittkopp/LabResearch/Simulating_ASE/revisions/new_plots/sim_36b_v2_box.pdf");
boxplot(ref_allele/(ref_allele+alt_allele) ~ relevant,data = data2, varwidth = TRUE,xlab="",ylab="",main="",xlim=c(1,9),ylim=c(0,1),pars = list(outpch=19,cex=0.2));
abline(h=0.5,lty=2,col="red");
dev.off();

pdf(file="/Users/kraigrs/Wittkopp/LabResearch/Simulating_ASE/revisions/new_plots/sim_36b_v3_box.pdf");
boxplot(ref_allele/(ref_allele+alt_allele) ~ relevant,data = data3, varwidth = TRUE,xlab="",ylab="",main="",xlim=c(1,9),ylim=c(0,1),pars = list(outpch=19,cex=0.2));
abline(h=0.5,lty=2,col="red");
dev.off();


pdf(file="/Users/kraigrs/Wittkopp/LabResearch/Simulating_ASE/revisions/new_plots/sim_36b_v0_box.pdf");
boxplot(ref_allele.x/(ref_allele.x+ref_allele.y) ~ relevant,data = data0, varwidth = TRUE,xlab="",ylab="",main="",xlim=c(1,9),ylim=c(0,1),pars = list(outpch=19,cex=0.2));
abline(h=0.5,lty=2,col="red");
dev.off();

pdf(file="/Users/kraigrs/Wittkopp/LabResearch/Simulating_ASE/revisions/new_plots/sim_36b_alt_v1_box.pdf");
boxplot(alt_allele/(ref_allele+alt_allele) ~ relevant,data = data1_alt, varwidth = TRUE,xlab="",ylab="",main="",xlim=c(1,9),ylim=c(0,1),pars = list(outpch=19,cex=0.2));
abline(h=0.5,lty=2,col="red");
dev.off();
...
write.table(data,file="/Users/kraigrs/Wittkopp/LabResearch/Simulating_ASE/revisions/new_plots/sim_36b_SNPs_1mm.txt",quote=F,sep="\t",row.names=F,col.names=F);

temp <- subset(data,relevant <= 1);
write.table(temp,file="/Users/kraigrs/Wittkopp/LabResearch/Simulating_ASE/revisions/new_plots/sim_36b_SNPs_1mm_unbiased.txt",quote=F,sep="\t",row.names=F,col.names=F);

perfect <- subset(temp,sum/length == 1);
imperfect <- subset(temp,sum/length != 1);

write.table(perfect,file="/Users/kraigrs/Wittkopp/LabResearch/Simulating_ASE/revisions/new_plots/sim_36b_SNPs_1mm_unbiased_perfect.txt",quote=F,sep="\t",row.names=F,col.names=F);
...
pdf(file="/Users/kraigrs/Wittkopp/LabResearch/Simulating_ASE/revisions/new_plots/sim_36b_1mm_barplot_by_mapp.pdf");
...
write.table(data,file="/Users/kraigrs/Wittkopp/LabResearch/Simulating_ASE/revisions/new_plots/sim_36b_SNPs_2mm.txt",quote=F,sep="\t",row.names=F,col.names=F);

temp <- subset(data,relevant <= 2);
write.table(temp,file="/Users/kraigrs/Wittkopp/LabResearch/Simulating_ASE/revisions/new_plots/sim_36b_SNPs_2mm_unbiased.txt",quote=F,sep="\t",row.names=F,col.names=F);

perfect <- subset(temp,sum/length == 1);
imperfect <- subset(temp,sum/length != 1);

write.table(perfect,file="/Users/kraigrs/Wittkopp/LabResearch/Simulating_ASE/revisions/new_plots/sim_36b_SNPs_2mm_unbiased_perfect.txt",quote=F,sep="\t",row.names=F,col.names=F);
...
pdf(file="/Users/kraigrs/Wittkopp/LabResearch/Simulating_ASE/revisions/new_plots/sim_36b_2mm_barplot_by_mapp.pdf");
barplot(t(mat),beside=TRUE,names.arg=seq(0.05,1,0.05),ylim=c(0,1),xlab="",ylab="",main="",col=c("white","grey"));
dev.off();
...
write.table(data,file="/Users/kraigrs/Wittkopp/LabResearch/Simulating_ASE/revisions/new_plots/sim_36b_SNPs_3mm.txt",quote=F,sep="\t",row.names=F,col.names=F);

temp <- subset(data,relevant <= 3);
write.table(temp,file="/Users/kraigrs/Wittkopp/LabResearch/Simulating_ASE/revisions/new_plots/sim_36b_SNPs_3mm_unbiased.txt",quote=F,sep="\t",row.names=F,col.names=F);

perfect <- subset(temp,sum/length == 1);
imperfect <- subset(temp,sum/length != 1);

write.table(perfect,file="/Users/kraigrs/Wittkopp/LabResearch/Simulating_ASE/revisions/new_plots/sim_36b_SNPs_3mm_unbiased_perfect.txt",quote=F,sep="\t",row.names=F,col.names=F);
...
pdf(file="/Users/kraigrs/Wittkopp/LabResearch/Simulating_ASE/revisions/new_plots/sim_36b_3mm_barplot_by_mapp.pdf");
barplot(t(mat),beside=TRUE,names.arg=seq(0.05,1,0.05),ylim=c(0,1),xlab="",ylab="",main="",col=c("white","grey"));
dev.off();
...
write.table(data,file="/Users/kraigrs/Wittkopp/LabResearch/Simulating_ASE/revisions/new_plots/sim_36b_SNPs_0mm.txt",quote=F,sep="\t",row.names=F,col.names=F);

perfect <- subset(data,((sum.x/length.x)+(sum.y/length.y)) == 2);
imperfect <- subset(data,((sum.x/length.x)+(sum.y/length.y)) != 2);

write.table(perfect,file="/Users/kraigrs/Wittkopp/LabResearch/Simulating_ASE/revisions/new_plots/sim_36b_SNPs_0mm_unbiased_perfect.txt",quote=F,sep="\t",row.names=F,col.names=F);
...
pdf(file="/Users/kraigrs/Wittkopp/LabResearch/Simulating_ASE/revisions/new_plots/sim_36b_0mm_barplot_by_mapp.pdf");
barplot(t(mat),beside=TRUE,names.arg=seq(0.05,1,0.05),ylim=c(0,1),xlab="",ylab="",main="",col=c("white","grey"));
dev.off();
